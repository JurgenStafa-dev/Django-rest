    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance_sheet_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='business.balance_sheet')),
                ('business_basic_info_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='business.business_basic_info')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_conditional_risk_id', models.ManyToManyField(to='business.Business_Conditional_Risk')),
                ...
                ('business_structural_risk_id', models.ManyToManyField(to='business.Business_Structural_Risk')),
                ('business_systemic_risk_id', models.ManyToManyField(to='business.Business_Systemic_Risk')),
            ],
        ),
        migrations.AddField(
            model_name='business_systemic_risk',
            name='risk_weight_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='business.risk_weight'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='business_finance',
            name='cashflow_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='business.cashflow'),
        ),
        migrations.AddField(
            model_name='business_finance',
            name='income_statement_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='business.income_statement'),
        ),
        migrations.AddField(
