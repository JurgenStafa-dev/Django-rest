...
class Business_Condition(models.Model):
    ...
    leverage_on_tech = models.CharField(max_length=50, blank=True, default="")
    ...
    growth_1 = models.CharField(max_length=50, blank=True, default="")
    growth_2 = models.CharField(max_length=50, blank=True, default="")
    growth_3 = models.CharField(max_length=50, blank=True, default="")
...
class Business_Finance(models.Model):
    ...
    # foreign key area.
    business_basic_info_id = models.ForeignKey(
        Business_Basic_Info, on_delete=models.CASCADE)
    cashflow_id = models.OneToOneField(Cashflow, on_delete=models.CASCADE)
    balance_sheet_id = models.OneToOneField(
        Balance_sheet, on_delete=models.CASCADE)
    income_statement_id = models.OneToOneField(
        Income_Statement, on_delete=models.CASCADE)
